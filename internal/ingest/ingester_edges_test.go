...
func (provErrUnsup) GetLogs(ctx context.Context, address string, from, to uint64, topics [][]string) ([]eth.Log, error) { return nil, nil }
func (provErrUnsup) TraceBlock(ctx context.Context, from, to uint64, address string) ([]eth.Trace, error) { return nil, eth.ErrUnsupported }
...
func (provErr) GetLogs(ctx context.Context, address string, from, to uint64, topics [][]string) ([]eth.Log, error) { return nil, nil }
func (provErr) TraceBlock(ctx context.Context, from, to uint64, address string) ([]eth.Trace, error) { return nil, nil }
...
func TestBackfillFromGreaterThanTo(t *testing.T) {
    ...
    if err := ing.Backfill(context.Background()); err == nil { t.Fatal("expected error") }
}
