...
func (provRich) BlockTimestamp(ctx context.Context, block uint64) (int64, error) {
...
func (provRich) Transactions(ctx context.Context, address string, from, to uint64) ([]eth.Transaction, error) {
	return []eth.Transaction{{Hash: "0xdead", From: address, To: address, BlockNum: from, Status: 1}}, nil
}
...
func (provTraceErr) GetLogs(ctx context.Context, address string, from, to uint64, topics [][]string) ([]eth.Log, error) {
	return nil, nil
}
func (provTraceErr) TraceBlock(ctx context.Context, from, to uint64, address string) ([]eth.Trace, error) {
	return nil, errors.New("trace")
}
func (provTraceErr) Transactions(ctx context.Context, address string, from, to uint64) ([]eth.Transaction, error) {
	return nil, nil
}
