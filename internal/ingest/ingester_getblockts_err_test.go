...
func (tsErrProv) GetLogs(ctx context.Context, address string, from, to uint64, topics [][]string) ([]eth.Log, error) { return nil, nil }
func (tsErrProv) TraceBlock(ctx context.Context, from, to uint64, address string) ([]eth.Trace, error) { return nil, nil }
func (tsErrProv) BlockTimestamp(ctx context.Context, block uint64) (int64, error) { return 0, errors.New("ts") }
